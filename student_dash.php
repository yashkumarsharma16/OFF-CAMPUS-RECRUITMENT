<html>
		...
		<nav class="navbar navbar-fixed-top" id="top-nav">
			<div class="container-fluid">
				...
				<ul id="list1" class="nav navbar-nav">
					...
					<li class="active"><a href="document_dash.php">Upload Documents</a></li>
			 ...
			 <img class="img-responsive " src="CSS/Image/c1.jpg" height="120px" width="120px" align="center" style="border-radius:50%"></img> 
			  ...
			  //session_start();
				$servername="localhost:3308";
					...
					//$sql = "SELECT name,email,dob,branch,year,degree,phone FROM students";
					//$result=$conn->query($sql);
	...
	$sql = "SELECT name,email,phone,location,ceo,hr,worth,founder FROM companys";
	$result=$conn->query($sql);
