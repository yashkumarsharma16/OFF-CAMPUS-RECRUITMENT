	...
	<head>
	  ...
	  <?php
		...
		if($_SERVER["REQUEST_METHOD"]=="POST"){
			...
			$sql="INSERT into vacancy(company_name,job_title,salary,location,deadline,bond,age,degree,cgpa,twp,tenp) 
			values(\"".$_SESSION['name']."\",\"".$job_title."\",".$salary.",\"".$location."\",\"".$deadline."\",".$bond.",".$age.",\"".$degree."\",".$cgpa.",".$twp.",".$tenp." );";
			;
	  ...
	  ?>
        ...
        <div class="container">
		  ...
		  <li><label for="age"><b>Minimum age:</b></label>
