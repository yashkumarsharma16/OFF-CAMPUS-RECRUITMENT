...
<html>
	...
	<body>
		...
		<div class=" container-fluid" id="dash">
			<div class="row">
				...
				<div class="well col-sm-8" style="background-color:#AED4F1; height:auto; ;margin:10px;">
	...
	$sql = "SELECT name,email,dob,branch,year,cpi,twp,tenp,pwd,phone,degree FROM students";
	$result=$conn->query($sql);
...
<?php
 ...
 ?>
			       ...
			       <div class="well col-sm-6" style="background-color:#AED4F1; height:auto; margin:10px;padding: top 50px;">
